...
class InimigoBase(pygame.sprite.Sprite):
    def __init__(self, x, y, velocidade, cor, vida_maxima):
        super().__init__()
...
class ZumbiComum(InimigoBase):
    def __init__(self, x, y):
        ...
        super().__init__(x, y, velocidade=2, cor=(255, 0, 0), vida_maxima=3)


class ZumbiCorredor(InimigoBase):
    def __init__(self, x, y):
        # Corredor: Mais rápido (Velocidade 4), Cor Laranja, 1 de Vida (morre fácil)
        super().__init__(x, y, velocidade=4, cor=(255, 165, 0), vida_maxima=1)